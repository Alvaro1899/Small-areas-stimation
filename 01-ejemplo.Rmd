...
Con str(milk) , vemos que los datos consisten en 43 observaciones, una para cada área de publicación. La variable SmallArea es el identificador de las áreas de publicación. ni es el tamaño de la muestra de la encuesta en cada área, $y_i$ son las estimaciones directas de la encuesta sobre el consumo semanal promedio de leche entera fresca en 1989. Las estimaciones directas no tienen sesgo de diseño, la varianza es una medida de su precisión. Variable SD es la desviación estándar (SD) de las estimaciones directas. La desviación estándar es la raíz cuadrada de la varianza.
...
Si se observa el rango de los CV se observara que las estimaciones directas son bastantes volátiles. 
